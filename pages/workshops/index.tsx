    ...
    <>
      ...
      <div className='content__container workshops__container'>
        ...
        <section className='workshops__section'>
          <h2 className='main__subheader'>Freitag 06.10.2023</h2>
          <ul className='workshops__items'>
            ...
            <li className='workshops__item'>
              ...
              <p className='workshops__item-topic'>Schleierfächer</p>
            </li>
            <li className='workshops__item'>
              <p className='workshops__item-time'>13:30-15:30</p>
              <p className='workshops__item-name'>Leandro Ferreyra</p>
              <p className='workshops__item-topic'>Tango oriental</p>
            </li>
            <li className='workshops__item'>
        ...
        <section className='workshops__section'>
          <h2 className='main__subheader'>Samstag 07.10.2023</h2>
          <ul className='workshops__items'>
            <li className='workshops__item'>
            ...
            <li className='workshops__item'>
              ...
              <p className='workshops__item-topic'>Ort: Virchowstr. 41, Neuruppin</p>
            </li>
          </ul>
        </section>
        <section className='workshops__section'>
          <h2 className='main__subheader'>Sonntag 08.10.2023</h2>
          <ul className='workshops__items'>
            <li className='workshops__item'>
              <p className='workshops__item-time'>09:00-11:00</p>
              <p className='workshops__item-name'>1. Rayana</p>
              <p className='workshops__item-topic'>Tabla Solo</p>
              <p className='workshops__item-name'>2. Marina</p>
              <p className='workshops__item-topic'>Baladi</p>
            </li>
            <li className='workshops__item'>
              <p className='workshops__item-time'>11:15-13:15</p>
              <p className='workshops__item-name'>Shalymar</p>
              <p className='workshops__item-topic'>Schleier Traum</p>
            </li>
            <li className='workshops__item'>
              <p className='workshops__item-time'>13:30-15:30</p>
              <p className='workshops__item-name'>Leandro Ferreyra</p>
              <p className='workshops__item-topic'>Mejance</p>
            </li>
            <li className='workshops__item'>
              ...
              <p className='workshops__item-topic'>Grundschritte</p>
            </li>
          </ul>
        </section>
